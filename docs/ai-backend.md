...
|---|---|---|
| `MEMORY_AI_BASE_URL` | `http://localhost:11434/v1` | Base URL of the OpenAI-compatible endpoint |
| `MEMORY_AI_API_KEY` | *(empty)* | Bearer token / API key — leave empty for local providers |
